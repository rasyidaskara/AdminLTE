        ...
        <div class="col-md-12">
            ...
            <div class="card card-info card-outline mb-4">
                ...
                <div class="card-header">
                    <div class="card-title">Form Input Data Mahasiswa</div>
                </div>
                <!--end::Header-->
                <!--begin::Form-->
                <form class="needs-validation" novalidate="" method="post"
                    action="index.php?page=mahasiswa_tangkap">
                    <!--begin::Body-->
                    <div class="card-body">
                        <!--begin::Row-->
                        <div class="row g-3">
                            <!--begin::Col-->
                            <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">NIM
                                    <span class="required-indicator sr-only"> (required)</span>
                                </label>
                                <input type="text" class="form-control" id="validationCustom01"
                                    value="" required="true" name="nim" id="nim">
                            </div>
                            <!--end::Col-->

                            <!--begin::Col-->
                            <div class="col-md-6">
                                <label for="validationCustom02" class="form-label">Nama Mahasiswa
                                    <span class="required-indicator sr-only"> (required)</span>
                                </label>
